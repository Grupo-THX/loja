    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                '<div class="input-group produto ${groupClass}">' +
                '<button style="min-width: ${buttonsWidth}" class="thx_btn btn-decrement ${buttonsClass} btn-minus" type="button">${decrementButton}</button>' +
                '<input type="text" inputmode="decimal" style="text-align: ${textAlign}" class="form-control form-control-text-input"/>' +
                '<button style="min-width: ${buttonsWidth}" class="thx_btn btn-increment ${buttonsClass} btn-plus" type="button">${incrementButton}</button>' +
                '</div>'
        }
        ...
        this.each(function () {
            ...
            function updateAttributes() {
                ...
                $inputGroup.prop("class", "input-group produto " + groupClass + " " + props.groupClass)
                $input.prop("class", "form-control produto thx_border-radius-zero" + inputClass)
